...
def insert(win, position):
    ...
    myfont = pygame.font.SysFont('Didot', 35)
    while True:
...
def main():
    ...
    myfont = pygame.font.SysFont('Didot', 55)  #adding the font and its size

    # creating grid
    color_grid = (200, 100, 50)
    for i in range(0, 10):
        if (i % 3 == 0):
            # drwaing the block line (vertical)
            pygame.draw.line(win, color_grid, (50 + 50 * i, 50), (50 + 50 * i, 500), 4)
            # (Horizontal)
            pygame.draw.line(win, color_grid, (50, 50 + 50 * i), (500, 50 + 50 * i), 4)

        # drwaing vertical line
        pygame.draw.line(win, color_grid, (50 + 50 * i, 50), (50 + 50 * i, 500), 2)
        # drwaing horizental line
        pygame.draw.line(win, color_grid, (50, 50 + 50 * i), (500, 50 + 50 * i), 2)
    pygame.display.update()
    ...
    for i in range(0, len(grid[0])):
        for j in range(0, len(grid[0])):
            if (0 < grid[i][j] < 10):
                ...
                win.blit(value, ((j + 1) * 50 + 15, (i + 1) * 50 + 10))
    pygame.display.update()
